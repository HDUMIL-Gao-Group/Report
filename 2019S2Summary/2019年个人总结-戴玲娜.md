...
> 详细实验结果见[github](https://github.com/xinzi2018/mystudy)

### 应用singan思路生成人脸素描

> 详细实验报告见 [github](https://github.com/HDUMIL-Gao-Group/SinGAN-for-Sketch)
...
> 由于实验结果比较多，详细结果可见 [github](https://github.com/HDUMIL-Gao-Group/SinGAN-for-Sketch)
